...
function Login() {
  ...
  return (
    <div className='container flex flex-col mx-auto mt-10 justify-start items-center h-80 w-128 p-10 bg-gray-50 font-gemunu'>
        <h2 className='text-cyan-600 text-3xl font-semibold uppercase'>Welcome to Your Digital Oasis</h2>
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='flex justify-between items-center my-3'>
                <Link to="/register" className='text-cyan-700 hover:underline duration-300'>Don't have an account?</Link>
            </div>
            <button className='bg-cyan-600 py-2 px-14 w-full rounded-sm text-white hover:bg-cyan-500 duration-300' 
                    type='submit'>Go in</button>                
        </form>
    </div>
  )
}
